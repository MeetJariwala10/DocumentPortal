# NOTE: Test code for document ingestion and analysis using a PDFHandler and DocumentAnalyzer
...
# NOTE: Testing code for document comparison using LLMs
...
#     ref_path = Path("D:\\LLMOPs_Krish_Naik\\DocumentPortal\\data\\document_compare\\Long_Report_V1.pdf")
#     act_path = Path("D:\\LLMOPs_Krish_Naik\\DocumentPortal\\data\\document_compare\\Long_Report_V2.pdf")
...
# NOTE: Testing code for document chat functionality
...
#     question = "what is the significance of attention mechanism. explain it in simple terms"
...
# NOTE: Testing for multi doc chat
